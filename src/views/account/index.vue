      ...
      <div class="account-container">
        <div class="account-left">
          ...
          <ul class="account-ul">
            <li
              class="account-item"
              :class="{ on: state.activeIdx === 0 }"
              @click="clickBarItem(state.navList[0].path, 0)"
            >
              <svg
                t="1710594508716"
                class="icon"
              ...
              >
                <path
                  d="M949.1 489.8L590.4 131.1c-43.2-43.2-113.5-43.2-156.8 0L74.9 489.8c-14.6 14.6-14.6 38.3 0 52.9 14.6 14.6 38.3 14.6 52.9 0l4.9-4.9v276.7c0 61.1 49.7 110.8 110.8 110.8h536.8c61.1 0 110.8-49.7 110.8-110.8V537.8l4.9 4.9c7.3 7.3 16.9 11 26.5 11s19.2-3.7 26.5-11c14.7-14.6 14.7-38.3 0.1-52.9zM816.4 814.5c0 19.8-16.1 36-36 36H243.6c-19.8 0-36-16.1-36-36V463l279-279c14-14 36.8-14 50.9 0l278.9 279v351.5z"
                  p-id="4479"
                ></path>
                <path
                  d="M351 553.1c-9.7-18.3-32.3-25.2-50.6-15.6-18.3 9.7-25.2 32.3-15.6 50.6 47.9 90.5 132.8 144.5 227.2 144.5s179.3-54 227.2-144.5c9.7-18.3 2.7-40.9-15.6-50.6-18.3-9.7-40.9-2.7-50.6 15.6-34.7 65.5-94.9 104.7-161 104.7s-126.3-39.2-161-104.7z"
                  p-id="4480"
                ></path>
              </svg>
            ...
            <li
              class="account-item"
              :class="{ on: state.activeIdx === 1 }"
              @click="clickBarItem(state.navList[1].path, 1)"
            >
              <svg
                t="1710596444032"
                class="icon"
            ...
            <li
              class="account-item"
              :class="{ on: state.activeIdx === 2 }"
              @click="clickBarItem(state.navList[2].path, 2)"
            >
              <svg
                t="1710596480833"
                class="icon"
              ...
              >
                <path
                  d="M243.05652178 782.58695644A303.33913067 303.33913067 0 0 1 512 619.60869599c114.90652177 0 217.56521778 64.48695644 268.96304355 162.97826045A380.34782578 380.34782578 0 0 0 893.52173955 512h58.69565157c0 243.11739112-197.1 440.21739112-440.21739112 440.21739112S71.78260888 755.11739112 71.78260888 512 268.88260888 71.78260888 512 71.78260888c179.13913067 0 338.34130401 108 406.29130401 270.46956534l-54.15652178 22.63695644A381.6 381.6 0 0 0 512 130.47826045C301.28260888 130.47826045 130.47826045 301.28260888 130.47826045 512a380.34782578 380.34782578 0 0 0 112.57826133 270.58695644z m46.17391289 39.16956533A379.8 379.8 0 0 0 512 893.52173955c83.15217422 0 160.08260888-26.60869599 222.76956533-71.76521778a244.66304355 244.66304355 0 0 0-445.53913066 0zM512 571.55652178a146.73913067 146.73913067 0 1 1 0-293.47826133 146.73913067 146.73913067 0 0 1 0 293.47826133z m0-58.69565245a88.04347823 88.04347823 0 1 0 0-176.08695644 88.04347823 88.04347823 0 0 0 0 176.08695645z"
                  p-id="5540"
                ></path>
              </svg>
            ...
            <li
              class="account-item"
              :class="{ on: state.activeIdx === 3 }"
              @click="clickBarItem(state.navList[3].path, 3)"
            >
              <svg
                t="1710596501350"
                class="icon"
          ...
          <ul class="account-ul">
            <li class="account-item-jump">
              <a
                :href="`/space/${useUser.userinfo.uid}`"
                target="_blank"
                class="jump-link"
              >
                个人空间
...
watch(
  ...
  (newVal) => {
    state.navList.forEach((item, index) => {
      if (newVal.startsWith(item.path)) {
        state.activeIdx = index;
      }
    });
  },
...
const clickBarItem = (path: RouteLocationRaw, index: number) => {
  state.activeIdx = index;
  router.push(path);
};
</script>
...
.top-header {
  width: 100%;
  height: 106px;
  background: url('@/assets/images/background/account.jpg') repeat-x;
}
...
.top-img {
  ...
  height: 106px;
  margin: 0 auto;
  /* background: url('@/assets/images/background/account_top.png') no-repeat; */
}
