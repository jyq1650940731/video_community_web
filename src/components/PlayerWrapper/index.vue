                ...
                <div class="player-video-area" id="video-area"
                    ...
                    <div class="player-video-perch">
                        <div class="player-video-wrap">
                            <video ref="videoPlayer" :src="videoUrl" @loadedmetadata="videoCanPlay" @timeupdate="timeUpdate"
                                @progress="updateBufferingBar" @waiting="buff = true" @canplay="buff = false" @ended="ended"
                                :loop="setting.loop"></video>
                        </div>
                    </div>
                    <!-- 弹幕 -->
                            ...
                            <div v-if="user.uid">
                                <div class="player-follow" @mouseenter="showCtrlAlweys">
                                    ...
                                    <svg t="1700578364917" class="icon player-follow-icon" viewBox="0 0 1024 1024"
                                        version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3687" width="12" height="12">
                                        <path
                                        ...
                                        <path d="M921.6 563.2H102.4a51.2 51.2 0 0 1 0-102.4h819.2a51.2 51.2 0 0 1 0 102.4z"
                            ...
                            <div class="player-control-bottom">
                                <div class="player-control-bottom-left">
                                    <div class="player-ctrl-btn player-ctrl-prev" v-if="false">
                                        ...
                                        <div class="player-ctrl-btn-icon">
                                            <span class="common-svg-icon">
                                                <svg t="1700643760528" class="icon" viewBox="0 0 1024 1024" version="1.1"
                                                    xmlns="http://www.w3.org/2000/svg" p-id="3961" width="22" height="22">
                                                    <path
                                    ...
                                    <div class="player-ctrl-btn player-ctrl-play">
                                        ...
                                        <div class="player-ctrl-btn-icon player-ctrl-play-play"
                                            ...
                                            <span class="common-svg-icon">
                                                <svg t="1700644047374" class="icon" viewBox="0 0 1024 1024" version="1.1"
                                                    xmlns="http://www.w3.org/2000/svg" p-id="4206" width="22" height="22">
                                                    <path
                                        ...
                                        <div class="player-ctrl-btn-icon player-ctrl-play-pause"
                                            ...
                                            <span class="common-svg-icon">
                                                <svg t="1700644104462" class="icon" viewBox="0 0 1024 1024" version="1.1"
                                                    xmlns="http://www.w3.org/2000/svg" p-id="4447" width="22" height="22">
                                                    <path
                                    ...
                                    <div class="player-ctrl-btn player-ctrl-next" v-if="false">
                                        ...
                                        <div class="player-ctrl-btn-icon">
                                            <span class="common-svg-icon">
                                                <svg t="1700644237259" class="icon" viewBox="0 0 1024 1024" version="1.1"
                                                    xmlns="http://www.w3.org/2000/svg" p-id="4688" width="22" height="22">
                                                    <path
                                        ...
                                        <div class="player-dm-root">
                                            ...
                                            <div class="player-dm-setting player-dm-outside"
                                                ...
                                                <svg t="1700490442936" class="icon" viewBox="0 0 1024 1024" version="1.1"
                                                    xmlns="http://www.w3.org/2000/svg" p-id="3841" width="100%"
                                                    height="100%">
                                                    <path
                                                                    ...
                                                                    <div class="v-ui-panel-item v-ui-panel-item-active"
                                                                        ...
                                                                        <div class="player-dm-setting-left">
                                                                            <div class="player-dm-setting-left-opacity">
                                                                                <div class="player-dm-setting-left-title">
                                                                                    不透明度</div>
                                                                        ...
                                                                        <div class="selection-span type-mode"
                                                                            ...
                                                                            <span class="selection-icon">
                                                                                <svg t="1700749596256" class="icon"
                                                                                    viewBox="0 0 1192 1024" version="1.1"
                                ...
                                <div class="player-control-bottom-right">
                                    ...
                                    <div class="player-ctrl-btn player-ctrl-setting"
                                        ...
                                        <div class="player-ctrl-btn-icon">
                                            <span class="common-svg-icon">
                                                <svg t="1700669811042" class="icon" viewBox="0 0 1024 1024" version="1.1"
                                                    xmlns="http://www.w3.org/2000/svg" p-id="7338" width="22" height="22">
                                                    <path
                                    ...
                                    <div class="player-ctrl-btn player-ctrl-volume"
                                        ...
                                        <div class="player-ctrl-btn-icon" @click="changeMutedState">
                                            <span class="common-svg-icon">
                                                <svg v-if="isMuted" t="1700670251969" class="icon" viewBox="0 0 1024 1024"
                                                    version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4236" width="22"
                                                    height="22">
                                                    <path
                                                ...
                                                <svg v-else t="1700670170727" class="icon" viewBox="0 0 1024 1024"
                                                    version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3989" width="22"
                                                    height="22">
                                                    <path
                    ...
                    <div class="player-shadow-progress-area">
                        <div class="player-shadow-progress-schedule-wrap">
                            <div class="player-progress-schedule">
                                <div class="player-progress-schedule-buffer" :style="`transform: scaleX(${bufferPer});`">
                                </div>
                ...
                <div class="player-sending-area">
                    ...
                    <div class="player-dm-root">
                        ...
                        <el-tooltip :visible="dmTips" placement="top" :show-arrow="false">
                            ...
                            <div class="player-dm-switch player-dm-outside" @click="changeDanmu" @mouseenter="dmTips = true"
                                @mouseleave="dmTips = false">
                                <svg v-if="danmuOpen" t="1700487450055" class="icon" viewBox="0 0 1024 1024" version="1.1"
                                    xmlns="http://www.w3.org/2000/svg" p-id="7051" width="100%" height="100%">
                                    <path
                                        d="M673.10933333 432.64H616.6755552v40.50488854h56.43377813v-40.50488854z m-106.95111146 0h-53.7031104v40.50488854h53.7031104v-40.50488854z m0 82.37511147h-53.7031104v38.22933333h53.7031104v-38.22933333z m106.95111146 0H616.6755552v38.22933333h56.43377813v-38.22933333z m-27.30666666-206.16533333l48.69688853 17.29422186c-10.0124448 23.66577813-21.39022187 44.60088853-33.67822187 63.2604448h57.344v207.0755552h-101.94488853v37.77422187h121.0595552v47.78666667l-0.45511147 0.45511146h-120.60444373l-0.45511147-0.45511146c-30.9475552-33.22311147-82.83022187-35.49866667-116.5084448-4.5511104l-5.00622186 5.00622186h-46.42133334v-48.24177813h117.41866667v-37.77422187h-99.66933333v-207.0755552h59.1644448a386.38933333 386.38933333 0 0 0-36.864-60.9848896l46.87644373-15.92888853c13.65333333 19.56977813 26.3964448 40.50488853 36.4088896 62.80533333l-30.94755627 13.65333334h68.26666667c14.5635552-24.576 26.3964448-51.88266667 37.31911147-80.0995552z m-212.08177814 21.84533333v151.552H344.97422187l-6.82666667 66.44622187h98.75911147c0 84.65066667-3.18577813 141.0844448-7.73688854 169.7564448-5.9164448 28.672-30.9475552 44.14577813-76.00355626 47.3315552-12.74311147 0-25.48622187-0.91022187-39.59466667-1.8204448l-13.19822187-47.78666667c12.74311147 1.36533333 26.8515552 2.2755552 40.50488854 2.27555627 24.576 0 38.6844448-7.73688853 41.87022293-23.66577814 3.64088853-15.92888853 5.46133333-49.60711147 5.46133333-101.94488853H285.35466667l13.65333333-154.28266667h83.28533333v-63.71555626H289.90577813v-43.69066667h143.8151104v-0.4551104z"
                                        p-id="7052"></path>
                                    <path
                                                    ...
                                                    <div class="player-dm-setting-left">
                                                        <div class="player-dm-setting-left-opacity">
                                                            ...
                                                            <div class="player-dm-setting-left-content">
                                                                <div class="v-ui" style="height: 12px;">
                                                                    <div class="v-ui-area">
                                                                        <SliderRow class="player-dm-setting-left-progress"
                                                                            :currentPer="dmSetting.opacity / 100"
                                                                            :sliderWidth="182"
                                                                            v-model:order="dmOpacityOrder"
                                                                            @changeCurrent="changeDmOpacity"></SliderRow>
                                                                        <div class="player-dm-setting-left-value">{{
                                                                            dmSetting.opacity }}%</div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                            ...
                            <div class="player-video-inputbar-wrap">
                                ...
                                <div class="player-dm-btn-font player-dm-outside"
                                    ...
                                    <svg t="1700493799646" class="icon player-dm-btn-font-icon" viewBox="0 0 1024 1024"
                                        version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="6734" width="20" height="20">
                                        <path
                                            d="M220.36510341 728.70570667h139.03341036l57.78818844-140.5868563h226.4147437l54.9143135 140.5868563h146.25693392L584.41515614 45.96622222H480.64496829l-260.27986488 682.73948445zM609.81399703 473.94057482H447.01286399L530.43291021 234.70990222 609.81399703 474.01824711zM166.30518518 819.65996563v136.54789689h728.17777778V819.58229333H166.30518518z"
                                            p-id="6735"></path>
                                    </svg>
                                    <div class="player-mode-selection-container">
                                        <div class="player-mode-selection-panel">
                                            ...
                                            <div class="player-mode-selection-row">
                                                ...
                                                <div class="row-selection">
                                                    <div class="selection-span type-mode"
                                                        :class="{ 'active': dmStyle.mode === 1 }" @click="dmStyle.mode = 1">
                                                        <span class="selection-icon">
                                                    ...
                                                    <div class="selection-span type-mode"
                                                        :class="{ 'active': dmStyle.mode === 2 }" @click="dmStyle.mode = 2">
                                                        <span class="selection-icon">
                                                    ...
                                                    <div class="selection-span type-mode"
                                                        :class="{ 'active': dmStyle.mode === 3 }" @click="dmStyle.mode = 3">
                                                        <span class="selection-icon">
...
.player-video-area[data-ctrl-hidden=true] .player-control-bottom,
.player-video-area[data-ctrl-hidden=true] .player-control-mask {
    opacity: 0;
}

.player-video-area[data-ctrl-hidden=false] .player-control-bottom,
.player-video-area[data-ctrl-hidden=false] .player-control-mask {
    opacity: 1;
...
.player-video-area[data-screen=full] .player-ctrl-eplist,
.player-video-area[data-screen=web] .player-ctrl-eplist {
    visibility: visible;
}
...
.player-video-area[data-screen=full] .player-sending-bar .player-dm-input /deep/ .el-input__inner,
.player-video-area[data-screen=web] .player-sending-bar .player-dm-input /deep/ .el-input__inner {
    color: #fff;
}
...
@media screen and (min-width: 750px) {
    ...
    .player-video-area[data-screen=full] .player-top-left,
    .player-video-area[data-screen=web] .player-top-left {
        left: 24px;
        margin-top: 24px;
    }

    .player-video-area[data-screen=full] .player-title,
    .player-video-area[data-screen=web] .player-title {
        margin-bottom: 12px;
    }

    .player-video-area[data-screen=full] .player-follow,
    .player-video-area[data-screen=web] .player-follow {
        height: 40px;
        line-height: 40px;
        margin-bottom: 12px;
        width: 97px;
    ...
    .player-video-area[data-screen=full] .player-follow-face,
    .player-video-area[data-screen=web] .player-follow-face {
        height: 32px;
        width: 32px;
    }

    .player-video-area[data-screen=full] .player-control-entity,
    .player-video-area[data-screen=full] .player-control-wrap,
    .player-video-area[data-screen=web] .player-control-entity,
    .player-video-area[data-screen=web] .player-control-wrap {
        height: 93px;
        line-height: 93px;
    }

    .player-video-area[data-screen=full] .player-control-top,
    .player-video-area[data-screen=web] .player-control-top {
        bottom: 68px;
    }

    .player-video-area[data-screen=full] .player-control-bottom,
    .player-video-area[data-screen=web] .player-control-bottom {
        height: 45px;
        line-height: 34px;
        margin: 40px 0 0;
    }

    .player-video-area[data-screen=full] .player-control-bottom-left,
    .player-video-area[data-screen=web] .player-control-bottom-left {
        min-width: 316px;
    }

    .player-video-area[data-screen=full] .player-ctrl-btn,
    .player-video-area[data-screen=web] .player-ctrl-btn {
        height: 43px;
        line-height: 32px;
        width: 54px;
    }

    .player-video-area[data-screen=full] .player-ctrl-btn-icon .common-svg-icon,
    .player-video-area[data-screen=web] .player-ctrl-btn-icon .common-svg-icon {
        height: 28px;
    }

    .player-video-area[data-screen=full] .player-ctrl-time,
    .player-video-area[data-screen=web] .player-ctrl-time {
        height: 32px;
        width: 120px;
    }

    .player-video-area[data-screen=full] .player-ctrl-time-label,
    .player-video-area[data-screen=web] .player-ctrl-time-label {
        font-size: 14px;
        text-align: left;
        text-indent: 16px;
    }
    ...
    .player-video-area[data-screen=full] .player-sending-bar,
    .player-video-area[data-screen=web] .player-sending-bar {
    ...
    .player-video-area[data-screen=full] .player-ctrl-quality,
    .player-video-area[data-screen=web] .player-ctrl-quality {
        width: auto;
    }

    .player-video-area[data-screen=full] .player-ctrl-playbackrate,
    .player-video-area[data-screen=web] .player-ctrl-playbackrate {
        width: 66px;
    }

    .player-video-area[data-screen=full] .player-ctrl-quality-result,
    .player-video-area[data-screen=web] .player-ctrl-quality-result,
    .player-video-area[data-screen=full] .player-ctrl-eplist-result,
    .player-video-area[data-screen=web] .player-ctrl-eplist-result,
    .player-video-area[data-screen=full] .player-ctrl-playbackrate-result,
    .player-video-area[data-screen=web] .player-ctrl-playbackrate-result {
        font-size: 16px;
    }

    .player-video-area[data-screen=full] .player-ctrl-playbackrate-menu,
    .player-video-area[data-screen=web] .player-ctrl-playbackrate-menu,
    .player-video-area[data-screen=full] .player-ctrl-volume-box,
    .player-video-area[data-screen=web] .player-ctrl-volume-box {
        bottom: 74px;
    }

    .player-video-area[data-screen=full] .player-ctrl-setting-box,
    .player-video-area[data-screen=web] .player-ctrl-setting-box {
        bottom: 74px;
        right: -40px;
    }
}
