                ...
                <div class="table-header">
                    <div class="btn-time" @click="resort(sortType === 1 ? 2 : 1)">
                        ...
                        <span class="btn-icon" :style="sortType === 2 ? 'transform: rotate(180deg);' : ''">
                            <svg v-if="sortType === 1 || sortType === 2" t="1703521678193" class="icon"
                                viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4190"
                                id="mx_n_1703521678194" width="100%" height="100%">
                                <path
                    ...
                    <div class="btn-text" @click="resort(sortType === 3 ? 4 : 3)">
                        ...
                        <span class="btn-icon" :style="sortType === 4 ? 'transform: rotate(180deg);' : ''">
                            <svg v-if="sortType === 3 || sortType === 4" t="1703521678193" class="icon"
                                viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4190"
                                id="mx_n_1703521678194" width="100%" height="100%">
                                <path
                                    d="M513.14147073 768.58829205c-12.66872461 0-24.8085135-5.09964346-33.67662059-14.14942196L70.7988117 337.4625982c-18.22977994-18.59794446-17.92753049-48.45304726 0.67202119-66.68121997 18.59794446-18.22656391 48.45465606-17.92753049 66.68121997 0.67202117l374.98941787 382.6147692L888.13089019 271.4533994c18.22656391-18.60116048 48.08005952-18.90501713 66.68121996-0.67202117 18.60116048 18.22977994 18.90180111 48.08327553 0.67202117 66.68121997L546.81809132 754.43887009C537.94998425 763.4886486 525.81180415 768.58829205 513.14147073 768.58829205z"
                    ...
                    <div class="btn-date" @click="resort(sortType === 5 ? 6 : 5)">
                        ...
                        <span class="btn-icon" :style="sortType === 6 ? 'transform: rotate(180deg);' : ''">
                            <svg v-if="sortType === 5 || sortType === 6" t="1703521678193" class="icon"
                                viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4190"
                                id="mx_n_1703521678194" width="100%" height="100%">
                                <path
                                    d="M513.14147073 768.58829205c-12.66872461 0-24.8085135-5.09964346-33.67662059-14.14942196L70.7988117 337.4625982c-18.22977994-18.59794446-17.92753049-48.45304726 0.67202119-66.68121997 18.59794446-18.22656391 48.45465606-17.92753049 66.68121997 0.67202117l374.98941787 382.6147692L888.13089019 271.4533994c18.22656391-18.60116048 48.08005952-18.90501713 66.68121996-0.67202117 18.60116048 18.22977994 18.90180111 48.08327553 0.67202117 66.68121997L546.81809132 754.43887009C537.94998425 763.4886486 525.81180415 768.58829205 513.14147073 768.58829205z"
                    ...
                    <ul class="dm-list">
                        <li class="dm-item" v-for="(item, index) in dmList" :key="index">
                            <div class="dm-info-row" @dblclick="handleDblClick(item.timePoint)">
                                ...
                                <span class="dm-info-report-btn" @click.stop="noOption"
                                    @dblclick.stop="stopOption">举报</span>
                                <span class="dm-info-delete-btn"
                                    ...
                                    @click.stop="beforeDelete(item.id)" @dblclick.stop="stopOption">删除</span>
                            </div>
                        </li>
                    </ul>
                </div>
