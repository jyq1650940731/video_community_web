<template>
  ...
  <el-dialog
    ...
    v-model="useUserStore().loginDialogVisible"
    center
    width="820"
    :close-on-click-modal="false"
    destroy-on-close
    align-center
    @close="close(formRef, registerRef)"
  >
...
const { login, register, setLoginDialogVisible } = useUserStore();
